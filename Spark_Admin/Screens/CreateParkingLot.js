...
function CreateParkingLot({navigation, prop}) {
  ...
  const [noOfElectricTruckParkingSlots, setElectricTruckParkingSlots] =
    useState(0);
    ...
    <ScrollView style={styles.scrollView}>
      <View style={{flex: 1, marginTop: 50, marginLeft: 20, marginRight: 20}}>
        ...
        <TextInput
          ...
          onChangeText={newText => setParkingSlotName(newText)}
        ...
        <View
          ...
          <TextInput
            ...
            onChangeText={newText => setParkingSlotLocation(newText)}
            defaultValue={parkingSlotLocation}
          />
          <TouchableOpacity
            activeOpacity={0.5}
            onPress={() => {
        ...
        <View style={{marginLeft: 20, marginRight: 20}}>
          <StepperComponent
            setValue={setBikeParkingSlots}
            label={'No of Bike Parking Slots'}
            topAlign={10}
          />
          <StepperComponent
            setValue={setCarParkingSlots}
            label={'No of Car Parking Slots'}
            topAlign={10}
          />
          <StepperComponent
            setValue={setElectricCarParkingSlots}
            label={'No of Electric Car Parking Slots'}
            topAlign={10}
          />
          <StepperComponent
            setValue={setTruckParkingSlots}
            label={'No of Truck Parking Slots'}
            topAlign={10}
          />
          <StepperComponent
            setValue={setElectricTruckParkingSlots}
            label={'No of Electric Truck Parking Slots'}
            topAlign={10}
          />
        </View>
        ...
        <View
          ...
          <CheckBoxComponent
            ...
            setValue={setCleaningServiceChecked}
          />
          <CheckBoxComponent
            label={'Mechanic Service'}
            setValue={setMechanicServiceChecked}
          />
        </View>
        ...
        <TouchableOpacity activeOpacity={0.5} onPress={createParkingLot}>
